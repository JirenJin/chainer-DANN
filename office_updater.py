...
class Updater(BaseDAUpdater):
    ...
    def __init__(self, s_iter, t_iter, optimizers, args):
        ...
        self.bottleneck = optimizers['bottleneck'].target
    ...
    def update_core(self):
        ...
        self.optimizers['encoder'].hyperparam.lr = lr
        self.optimizers['bottleneck'].hyperparam.lr = 10*lr
        self.optimizers['classifier'].hyperparam.lr = 10*lr
        self.optimizers['domain_classifier'].hyperparam.lr = 10*lr
        ...
        s_encoding = self.bottleneck(self.enc(s_imgs))
        ...
        if self.training_mode == 'dann':
            t_encoding = self.bottleneck(self.enc(t_imgs))
